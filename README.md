# Angular Boot Camp example: form-array
...
**[StackBlitz for form-array](https://stackblitz.io/github/AngularBootCamp/form-array)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/form-array.git
cd form-array
npm install
npm start
```
